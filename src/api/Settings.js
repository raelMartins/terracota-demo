...
export const fetchAccounts = async () => {
  ...
  return await axios.get(`${BaseURL_TWO}/store/add-account/?accounts=true&store=${storeName}`);
};
...
export const fetchSettings = async data => {
  return await axios.get(`${BaseURL_TWO}/store/store_settings`, `{  profile: true  }`);
};
...
export const addBankAccount = async ({bank_code: bankCode, account_number: accNum}) => {
  const storeName = store_name();
...
export const RemoveBankAccount = async id => {
  ...
  return await axios.delete(`${BaseURL_TWO}/store/store_settings/${id}?store_name=${storeName}`);
};
...
export const getSettingsData = async data => {
  ...
  return await axios.post(`${BaseURL_TWO}/store/store_settings?store_name=${storeName}`, data);
};
...
export const updateSettings = async data => {
  ...
  return await axios.patch(`${BaseURL_TWO}/store/store_settings?store_name=${storeName}`, data);
};
...
export const setUpRecurring = async (equityId, recurringPayload) => {
  return await axios.patch(`${BaseURL_TWO}/investment/equity/${equityId}/`, recurringPayload);
};
